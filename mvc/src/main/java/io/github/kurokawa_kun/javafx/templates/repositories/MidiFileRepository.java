...
public class MidiFileRepository 
{
    /**
     ...
     * @param path パス
     * @return ファイルのリスト
     * @throws IOException ファイルアクセス時の例外
     */
    public static List<Path> loadFiles(Path path) throws IOException 
    {
        ...
        //  グループ順にソート
        //  同一グループ内は名前順にソート
        collectedPaths.sort(Comparator.comparingInt(MidiFileRepository::getGroup).thenComparing(other -> other.getFileName().toString(), String.CASE_INSENSITIVE_ORDER));
