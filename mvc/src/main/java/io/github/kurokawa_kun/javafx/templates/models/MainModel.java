...
public class MainModel
{
    ...
    private static final Image IMAGE_PLAY_OFF = new Image(ICON_PLAY_OFF);
    private static final Image IMAGE_PLAY_ON = new Image(ICON_PLAY_ON);
    private static final Image IMAGE_PAUSE_ON = new Image(ICON_PAUSE_ON);
    ...
    private void initSequencer(Soundbank soundbank)
    {
        if (soundbank != null)
        {
            midiPlayer = new MidiPlayer(soundbank);
        }
    ...
    {
        soundFontRepository = new SoundFontRepository();
        midiFilesRepository = new MidiFileRepository();
